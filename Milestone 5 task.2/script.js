    ...
    if (profilePictureinput && nameElement && emailElement && phoneElement && educationElement &&
        ...
        if (resumeOutputElement) {
            ...
            shareLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                var shareLinkButton_1, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareLinkButton_1 = "https://yourdomain.com/resume/".concat(name_1.replace(/\s+/g, "_"), "_cv.html");
                            return [4 /*yield*/, navigator.clipboard.writeText(shareLinkButton_1)];
                        case 1:
                            _a.sent();
